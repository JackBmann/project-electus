...
/**
 * This class creates the Credits frame when it is created as an object.  It also monitors whether the user 
 * clicks clicks to go to the Menu and creates a new Menu.
 * @author Jack Baumann
 */
public class Credits extends JFrame implements MouseListener, Runnable {
    private boolean[] key;
    private boolean mouse;
    private BufferedImage back;
    private MouseEvent mouseE;
    private Platform background = new Platform(0, 0, 0, 0, "Credits.jpg", "background");
    private ArrayList<projectElectus.Entity> entityList = new ArrayList<>();
   
    /**
     * This constructor creates an object of the Credits class, sets the 
     ...
     * @param window - the window to draw the Credits onto
     */
    @Override
